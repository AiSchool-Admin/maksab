...
export function proxy(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "script-src-elem 'self' 'unsafe-inline' blob: https://unpkg.com https://cdn.jsdelivr.net",
      "worker-src 'self' blob:",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: blob: https://*.supabase.co https://*.supabase.in https://images.dubizzle.com.eg",
      "connect-src 'self' blob: https://*.supabase.co https://*.supabase.in wss://*.supabase.co https://unpkg.com https://cdn.jsdelivr.net https://tessdata.projectnaptha.com https://raw.githubusercontent.com",
