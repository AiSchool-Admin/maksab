...
const SUBCATEGORIES = [
  // Cars — IDs MUST match categories-config.ts exactly
  { id: "passenger", category_id: "cars", name: "سيارات ملاكي", slug: "passenger", sort_order: 1, is_active: true },
  { id: "microbus", category_id: "cars", name: "ميكروباص", slug: "microbus", sort_order: 2, is_active: true },
  { id: "trucks", category_id: "cars", name: "نقل", slug: "trucks", sort_order: 3, is_active: true },
  { id: "motorcycles", category_id: "cars", name: "موتوسيكلات", slug: "motorcycles", sort_order: 4, is_active: true },
  { id: "car-parts", category_id: "cars", name: "قطع غيار", slug: "car-parts", sort_order: 5, is_active: true },
  // Real Estate
  { id: "apartments-sale", category_id: "real_estate", name: "شقق للبيع", slug: "apartments-sale", sort_order: 1, is_active: true },
  { id: "apartments-rent", category_id: "real_estate", name: "شقق للإيجار", slug: "apartments-rent", sort_order: 2, is_active: true },
  { id: "villas", category_id: "real_estate", name: "فيلات", slug: "villas", sort_order: 3, is_active: true },
  { id: "land", category_id: "real_estate", name: "أراضي", slug: "land", sort_order: 4, is_active: true },
  { id: "commercial", category_id: "real_estate", name: "محلات تجارية", slug: "commercial", sort_order: 5, is_active: true },
  { id: "offices", category_id: "real_estate", name: "مكاتب", slug: "offices", sort_order: 6, is_active: true },
  // Phones
  { id: "mobile", category_id: "phones", name: "موبايلات", slug: "mobile", sort_order: 1, is_active: true },
  { id: "tablet", category_id: "phones", name: "تابلت", slug: "tablet", sort_order: 2, is_active: true },
  { id: "phone-accessories", category_id: "phones", name: "إكسسوارات", slug: "phone-accessories", sort_order: 3, is_active: true },
  { id: "phone-parts", category_id: "phones", name: "قطع غيار", slug: "phone-parts", sort_order: 4, is_active: true },
  // Fashion
  { id: "men", category_id: "fashion", name: "ملابس رجالي", slug: "men", sort_order: 1, is_active: true },
  { id: "women", category_id: "fashion", name: "ملابس حريمي", slug: "women", sort_order: 2, is_active: true },
  { id: "kids", category_id: "fashion", name: "ملابس أطفال", slug: "kids", sort_order: 3, is_active: true },
  { id: "shoes", category_id: "fashion", name: "أحذية", slug: "shoes", sort_order: 4, is_active: true },
  { id: "bags", category_id: "fashion", name: "شنط", slug: "bags", sort_order: 5, is_active: true },
  { id: "fashion-accessories", category_id: "fashion", name: "إكسسوارات", slug: "fashion-accessories", sort_order: 6, is_active: true },
  // Scrap
  { id: "iron", category_id: "scrap", name: "حديد", slug: "iron", sort_order: 1, is_active: true },
  { id: "aluminum", category_id: "scrap", name: "ألومنيوم", slug: "aluminum", sort_order: 2, is_active: true },
  { id: "copper", category_id: "scrap", name: "نحاس", slug: "copper", sort_order: 3, is_active: true },
  { id: "plastic", category_id: "scrap", name: "بلاستيك", slug: "plastic", sort_order: 4, is_active: true },
  { id: "paper", category_id: "scrap", name: "ورق", slug: "paper", sort_order: 5, is_active: true },
  { id: "old-devices", category_id: "scrap", name: "أجهزة قديمة", slug: "old-devices", sort_order: 6, is_active: true },
  { id: "construction", category_id: "scrap", name: "مخلفات بناء", slug: "construction", sort_order: 7, is_active: true },
  { id: "scrap-other", category_id: "scrap", name: "أخرى", slug: "scrap-other", sort_order: 8, is_active: true },
  // Gold
  { id: "gold-items", category_id: "gold", name: "ذهب", slug: "gold-items", sort_order: 1, is_active: true },
  { id: "silver", category_id: "gold", name: "فضة", slug: "silver", sort_order: 2, is_active: true },
  { id: "diamond", category_id: "gold", name: "ألماس", slug: "diamond", sort_order: 3, is_active: true },
  { id: "precious-watches", category_id: "gold", name: "ساعات ثمينة", slug: "precious-watches", sort_order: 4, is_active: true },
  // Luxury
  { id: "luxury-bags", category_id: "luxury", name: "شنط فاخرة", slug: "luxury-bags", sort_order: 1, is_active: true },
  { id: "sunglasses", category_id: "luxury", name: "نظارات", slug: "sunglasses", sort_order: 2, is_active: true },
  { id: "watches", category_id: "luxury", name: "ساعات", slug: "watches", sort_order: 3, is_active: true },
  { id: "perfumes", category_id: "luxury", name: "عطور", slug: "perfumes", sort_order: 4, is_active: true },
  { id: "pens", category_id: "luxury", name: "أقلام", slug: "pens", sort_order: 5, is_active: true },
  // Appliances
  { id: "washers", category_id: "appliances", name: "غسالات", slug: "washers", sort_order: 1, is_active: true },
  { id: "fridges", category_id: "appliances", name: "ثلاجات", slug: "fridges", sort_order: 2, is_active: true },
  { id: "cookers", category_id: "appliances", name: "بوتاجازات", slug: "cookers", sort_order: 3, is_active: true },
  { id: "ac", category_id: "appliances", name: "مكيفات", slug: "ac", sort_order: 4, is_active: true },
  { id: "heaters", category_id: "appliances", name: "سخانات", slug: "heaters", sort_order: 5, is_active: true },
  { id: "small-appliances", category_id: "appliances", name: "أجهزة صغيرة", slug: "small-appliances", sort_order: 6, is_active: true },
  // Furniture
  { id: "bedroom", category_id: "furniture", name: "غرف نوم", slug: "bedroom", sort_order: 1, is_active: true },
  { id: "dining", category_id: "furniture", name: "سفرة", slug: "dining", sort_order: 2, is_active: true },
  { id: "living", category_id: "furniture", name: "أنتريه", slug: "living", sort_order: 3, is_active: true },
  { id: "kitchen", category_id: "furniture", name: "مطابخ", slug: "kitchen", sort_order: 4, is_active: true },
  { id: "decor", category_id: "furniture", name: "ديكورات", slug: "decor", sort_order: 5, is_active: true },
  { id: "lighting", category_id: "furniture", name: "إضاءة", slug: "lighting", sort_order: 6, is_active: true },
  { id: "carpets", category_id: "furniture", name: "سجاد", slug: "carpets", sort_order: 7, is_active: true },
  { id: "furniture-other", category_id: "furniture", name: "أخرى", slug: "furniture-other", sort_order: 8, is_active: true },
  // Hobbies
  { id: "music", category_id: "hobbies", name: "آلات موسيقية", slug: "music", sort_order: 1, is_active: true },
  { id: "sports", category_id: "hobbies", name: "معدات رياضية", slug: "sports", sort_order: 2, is_active: true },
  { id: "gaming", category_id: "hobbies", name: "ألعاب فيديو", slug: "gaming", sort_order: 3, is_active: true },
  { id: "books", category_id: "hobbies", name: "كتب", slug: "books", sort_order: 4, is_active: true },
  { id: "cameras", category_id: "hobbies", name: "كاميرات", slug: "cameras", sort_order: 5, is_active: true },
  { id: "bikes", category_id: "hobbies", name: "دراجات", slug: "bikes", sort_order: 6, is_active: true },
  { id: "antiques", category_id: "hobbies", name: "تحف وأنتيكات", slug: "antiques", sort_order: 7, is_active: true },
  { id: "pets", category_id: "hobbies", name: "حيوانات أليفة", slug: "pets", sort_order: 8, is_active: true },
  // Tools
  { id: "hand-tools", category_id: "tools", name: "عدد يدوية", slug: "hand-tools", sort_order: 1, is_active: true },
  { id: "power-tools", category_id: "tools", name: "عدد كهربائية", slug: "power-tools", sort_order: 2, is_active: true },
  { id: "workshop", category_id: "tools", name: "معدات ورش", slug: "workshop", sort_order: 3, is_active: true },
  { id: "agricultural", category_id: "tools", name: "معدات زراعية", slug: "agricultural", sort_order: 4, is_active: true },
  { id: "restaurant-equipment", category_id: "tools", name: "معدات مطاعم", slug: "restaurant-equipment", sort_order: 5, is_active: true },
  // Services
  { id: "plumbing", category_id: "services", name: "سباكة", slug: "plumbing", sort_order: 1, is_active: true },
  { id: "electrical", category_id: "services", name: "كهرباء", slug: "electrical", sort_order: 2, is_active: true },
  { id: "painting", category_id: "services", name: "نقاشة", slug: "painting", sort_order: 3, is_active: true },
  { id: "carpentry", category_id: "services", name: "نجارة", slug: "carpentry", sort_order: 4, is_active: true },
  { id: "device-repair", category_id: "services", name: "صيانة أجهزة", slug: "device-repair", sort_order: 5, is_active: true },
  { id: "moving", category_id: "services", name: "نقل أثاث", slug: "moving", sort_order: 6, is_active: true },
  { id: "cleaning", category_id: "services", name: "تنظيف", slug: "cleaning", sort_order: 7, is_active: true },
  { id: "tech", category_id: "services", name: "خدمات تقنية", slug: "tech", sort_order: 8, is_active: true },
  { id: "tutoring", category_id: "services", name: "دروس خصوصية", slug: "tutoring", sort_order: 9, is_active: true },
  { id: "services-other", category_id: "services", name: "خدمات أخرى", slug: "services-other", sort_order: 10, is_active: true },
];
