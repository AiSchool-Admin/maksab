...
export const CS_INTENT_PATTERNS: Record<CSIntent, RegExp> = {
  ...
  technical: /مش شغال|خطأ|error|bug|مشكلة تقنية|بطيء|مش بيفتح/i,
  complaint: /شكوى|نصب|احتيال|مزيف|سرقة|بلاغ|مضروب/i,
  search: /ابحث|دوّر|فين|عايز اشتري|عايز أبيع/i,
  unknown: /./,
};
