    ...
    <div className="space-y-2">
      ...
      >
        ...
        <div className="flex-1 text-right">
          <p className="text-sm font-bold text-[#25D366]">مشاركة عبر واتساب</p>
          <p className="text-xs text-gray-text">ابعت لصحابك أو جروبات</p>
        </div>
      </button>
      ...
      >
        ...
        <div className="flex-1 text-right">
          <p className="text-sm font-bold text-[#1877F2]">مشاركة على فيسبوك</p>
          <p className="text-xs text-gray-text">انشر على حسابك أو جروبات</p>
        </div>
      </button>
      ...
      >
        ...
        <div className="flex-1 text-right">
          <p className="text-sm font-bold text-dark">
            {copied ? "تم نسخ الرابط!" : "نسخ رابط الإعلان"}
          </p>
          <p className="text-xs text-gray-text">ابعته في أي تطبيق</p>
        </div>
      </button>
      ...
      {typeof navigator !== "undefined" && "share" in navigator && (
        ...
        >
          ...
          <div className="flex-1 text-right">
            <p className="text-sm font-bold text-brand-green">مشاركة بطريقة تانية</p>
            <p className="text-xs text-gray-text">اختار أي تطبيق على موبايلك</p>
          </div>
        </button>
      )}
    </div>
    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/50" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-bold text-dark">شارك الإعلان</h3>
          <button
            onClick={onClose}
            className="p-1 text-gray-text hover:text-dark rounded-full hover:bg-gray-light transition-colors"
          >
            <X size={20} />
          </button>
        </div>
