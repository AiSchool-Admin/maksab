            ...
            <div className="space-y-2">
              {PAYMENT_METHODS.map((method) => (
                <div key={method.id}>
                  ...
                  {/* InstaPay — open link directly */}
                  {method.id === "instapay" && selectedMethod === "instapay" && "link" in method && (
                    <a
                      href={method.link}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full mt-2 py-3 bg-gradient-to-l from-purple-600 to-blue-600 text-white font-bold rounded-xl text-sm active:scale-[0.98] transition-transform"
                    >
