...
VALUES (
  'c0010001-0001-0001-0001-000000000001',
  '10000000-0001-0001-0001-000000000001',
  'b2222222-2222-2222-2222-222222222222',
  'a1111111-1111-1111-1111-111111111111',
...
VALUES
  ('e0010001-0001-0001-0001-000000000001', 'c0010001-0001-0001-0001-000000000001', 'b2222222-2222-2222-2222-222222222222', 'السلام عليكم، السيارة لسه متاحة؟', true, NOW() - INTERVAL '2 hours'),
  ('e0010001-0001-0001-0001-000000000002', 'c0010001-0001-0001-0001-000000000001', 'a1111111-1111-1111-1111-111111111111', 'وعليكم السلام، أيوا متاحة. تحبي تيجي تعاينيها؟', true, NOW() - INTERVAL '1 hour 50 minutes'),
  ('e0010001-0001-0001-0001-000000000003', 'c0010001-0001-0001-0001-000000000001', 'b2222222-2222-2222-2222-222222222222', 'ممكن أعرف آخر سعر؟ لو ينفع 420 ألف؟', true, NOW() - INTERVAL '1 hour 30 minutes'),
  ('e0010001-0001-0001-0001-000000000004', 'c0010001-0001-0001-0001-000000000001', 'a1111111-1111-1111-1111-111111111111', 'لا ده قليل شوية. ممكن 440 وتاخديها النهارده.', true, NOW() - INTERVAL '1 hour'),
  ('e0010001-0001-0001-0001-000000000005', 'c0010001-0001-0001-0001-000000000001', 'b2222222-2222-2222-2222-222222222222', 'تمام، هبعتلك لوكيشن عشان أجيلك. إن شاء الله بكرة الصبح.', false, NOW() - INTERVAL '15 minutes')
ON CONFLICT (id) DO NOTHING;

-- Conversation 2: Ahmed asks about a phone
INSERT INTO conversations (id, ad_id, buyer_id, seller_id, last_message_at, created_at)
VALUES (
  'c0020002-0002-0002-0002-000000000001',
  '10000000-0003-0003-0003-000000000001',
  'c3333333-3333-3333-3333-333333333333',
  'b2222222-2222-2222-2222-222222222222',
...
INSERT INTO messages (id, conversation_id, sender_id, content, is_read, created_at)
VALUES
  ('e0020002-0002-0002-0002-000000000001', 'c0020002-0002-0002-0002-000000000001', 'c3333333-3333-3333-3333-333333333333', 'الآيفون ده عليه أي خدش أو حاجة؟', true, NOW() - INTERVAL '5 hours'),
  ('e0020002-0002-0002-0002-000000000002', 'c0020002-0002-0002-0002-000000000001', 'b2222222-2222-2222-2222-222222222222', 'لا والله زيرو خالص. عليه جراب وإسكرينة من أول يوم.', true, NOW() - INTERVAL '4 hours 30 minutes'),
  ('e0020002-0002-0002-0002-000000000003', 'c0020002-0002-0002-0002-000000000001', 'c3333333-3333-3333-3333-333333333333', 'تمام. هل ممكن نتقابل في المهندسين؟', false, NOW() - INTERVAL '3 hours')
ON CONFLICT (id) DO NOTHING;
