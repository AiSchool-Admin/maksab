...
BEGIN
  ...
  RAISE NOTICE '✅ Stores setup complete!';
  RAISE NOTICE '   Tables created: stores, store_categories, store_followers, store_reviews, store_badges, store_pinned_products, store_analytics, store_promotions, store_subscriptions, user_wishlist, user_recently_viewed';
  RAISE NOTICE '   Current stores: %', store_count;
END;
$$;
