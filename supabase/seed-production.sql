-- ================================================================
-- مكسب Maksab — Production Seed Data
-- ================================================================
-- ملف واحد شامل لكل بيانات الإنتاج الأساسية
-- يمكن تشغيله عدة مرات بأمان (idempotent - ON CONFLICT)
--
-- المحتويات:
--   1. الأقسام الرئيسية (12 قسم)
--   2. الأقسام الفرعية (72 قسم فرعي)
--   3. المحافظات المصرية (27 محافظة)
--   4. المدن الرئيسية (~200 مدينة)
--   5. Storage Bucket لصور الإعلانات
--   6. جدول Phone OTP
--   7. إعدادات التطبيق الافتراضية
--   8. التحقق من البيانات
-- ================================================================


-- ============================================
-- PART 1: Categories (الأقسام الرئيسية)
-- ============================================
...
-- ============================================
-- PART 2: Subcategories (الأقسام الفرعية)
-- ============================================
...
-- ============================================
-- PART 3: Governorates (المحافظات المصرية)
-- ============================================

-- 1. القاهرة
INSERT INTO governorates (id, name, name_en) VALUES (1, 'القاهرة', 'Cairo') ON CONFLICT (id) DO NOTHING;
...
-- 2. الجيزة
INSERT INTO governorates (id, name, name_en) VALUES (2, 'الجيزة', 'Giza') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (2, 'الدقي', 'Dokki'),
...
-- 3. الإسكندرية
INSERT INTO governorates (id, name, name_en) VALUES (3, 'الإسكندرية', 'Alexandria') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (3, 'سموحة', 'Smouha'),
...
-- 4. القليوبية
INSERT INTO governorates (id, name, name_en) VALUES (4, 'القليوبية', 'Qalyubia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (4, 'بنها', 'Banha'),
...
-- 5. الشرقية
INSERT INTO governorates (id, name, name_en) VALUES (5, 'الشرقية', 'Sharqia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (5, 'الزقازيق', 'Zagazig'),
...
-- 6. الدقهلية
INSERT INTO governorates (id, name, name_en) VALUES (6, 'الدقهلية', 'Dakahlia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (6, 'المنصورة', 'Mansoura'),
  (6, 'طلخا', 'Talkha'),
  (6, 'ميت غمر', 'Mit Ghamr'),
...
-- 7. البحيرة
INSERT INTO governorates (id, name, name_en) VALUES (7, 'البحيرة', 'Beheira') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (7, 'دمنهور', 'Damanhour'),
...
-- 8. الغربية
INSERT INTO governorates (id, name, name_en) VALUES (8, 'الغربية', 'Gharbia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (8, 'طنطا', 'Tanta'),
...
-- 9. المنوفية
INSERT INTO governorates (id, name, name_en) VALUES (9, 'المنوفية', 'Monufia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 10. كفر الشيخ
INSERT INTO governorates (id, name, name_en) VALUES (10, 'كفر الشيخ', 'Kafr El Sheikh') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 11. دمياط
INSERT INTO governorates (id, name, name_en) VALUES (11, 'دمياط', 'Damietta') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (11, 'دمياط', 'Damietta'),
...
-- 12. بورسعيد
INSERT INTO governorates (id, name, name_en) VALUES (12, 'بورسعيد', 'Port Said') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 13. الإسماعيلية
INSERT INTO governorates (id, name, name_en) VALUES (13, 'الإسماعيلية', 'Ismailia') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 14. السويس
INSERT INTO governorates (id, name, name_en) VALUES (14, 'السويس', 'Suez') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (14, 'السويس', 'Suez'),
...
-- 15. شمال سيناء
INSERT INTO governorates (id, name, name_en) VALUES (15, 'شمال سيناء', 'North Sinai') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (15, 'العريش', 'El Arish'),
...
-- 16. جنوب سيناء
INSERT INTO governorates (id, name, name_en) VALUES (16, 'جنوب سيناء', 'South Sinai') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (16, 'الطور', 'El Tur'),
...
-- 17. الفيوم
INSERT INTO governorates (id, name, name_en) VALUES (17, 'الفيوم', 'Fayoum') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (17, 'الفيوم', 'Fayoum'),
...
-- 18. بني سويف
INSERT INTO governorates (id, name, name_en) VALUES (18, 'بني سويف', 'Beni Suef') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 19. المنيا
INSERT INTO governorates (id, name, name_en) VALUES (19, 'المنيا', 'Minya') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (19, 'المنيا', 'Minya'),
...
-- 20. أسيوط
INSERT INTO governorates (id, name, name_en) VALUES (20, 'أسيوط', 'Asyut') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (20, 'أسيوط', 'Asyut'),
...
-- 21. سوهاج
INSERT INTO governorates (id, name, name_en) VALUES (21, 'سوهاج', 'Sohag') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (21, 'سوهاج', 'Sohag'),
...
-- 22. قنا
INSERT INTO governorates (id, name, name_en) VALUES (22, 'قنا', 'Qena') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (22, 'قنا', 'Qena'),
...
-- 23. الأقصر
INSERT INTO governorates (id, name, name_en) VALUES (23, 'الأقصر', 'Luxor') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (23, 'الأقصر', 'Luxor'),
...
-- 24. أسوان
INSERT INTO governorates (id, name, name_en) VALUES (24, 'أسوان', 'Aswan') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (24, 'أسوان', 'Aswan'),
...
-- 25. البحر الأحمر
INSERT INTO governorates (id, name, name_en) VALUES (25, 'البحر الأحمر', 'Red Sea') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
  (25, 'الغردقة', 'Hurghada'),
  (25, 'سفاجا', 'Safaga'),
  (25, 'القصير', 'El Quseir'),
...
-- 26. الوادي الجديد
INSERT INTO governorates (id, name, name_en) VALUES (26, 'الوادي الجديد', 'New Valley') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- 27. مطروح
INSERT INTO governorates (id, name, name_en) VALUES (27, 'مطروح', 'Matrouh') ON CONFLICT (id) DO NOTHING;
INSERT INTO cities (governorate_id, name, name_en) VALUES
...
-- ============================================
-- PART 5: Storage Bucket for Ad Images
-- ============================================
DO $$
BEGIN
...
EXCEPTION
  WHEN insufficient_privilege THEN
    RAISE NOTICE 'Skipping storage bucket — requires service_role. Create "ad-images" bucket in Supabase Dashboard > Storage.';
  WHEN undefined_table THEN
    RAISE NOTICE 'storage.buckets not found — create "ad-images" bucket in Supabase Dashboard > Storage.';
END;
$$;
...
EXCEPTION
  WHEN insufficient_privilege THEN
    RAISE NOTICE 'Skipping storage policies — requires service_role.';
  WHEN undefined_table THEN
    RAISE NOTICE 'storage.objects not found — configure storage policies in Supabase Dashboard.';
END;
$$;


-- ============================================
-- PART 6: Phone OTP Table (for free verification)
-- ============================================
...
-- ============================================
-- PART 7: Default App Settings
-- ============================================
INSERT INTO app_settings (key, value, description, is_secret) VALUES
  ('commission_percentage', '1', 'نسبة العمولة المقترحة (%)', false),
  ('commission_min', '10', 'الحد الأدنى للعمولة (جنيه)', false),
  ('commission_max', '200', 'الحد الأقصى للعمولة (جنيه)', false),
  ('ad_expiry_days', '30', 'مدة صلاحية الإعلان (أيام)', false),
  ('max_images_per_ad', '10', 'الحد الأقصى لعدد الصور لكل إعلان', false),
  ('max_ads_per_day', '10', 'الحد الأقصى للإعلانات يومياً لكل مستخدم', false),
  ('otp_max_per_hour', '3', 'الحد الأقصى لطلبات OTP في الساعة', false),
  ('auction_anti_snipe_minutes', '5', 'دقائق تمديد المزاد عند المزايدة في آخر لحظة', false)
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '✅ مكسب — تم تحميل بيانات الإنتاج بنجاح!';
  RAISE NOTICE '   📦 الأقسام: % (المتوقع 12)', cat_count;
  RAISE NOTICE '   📂 الأقسام الفرعية: % (المتوقع 72)', sub_count;
  RAISE NOTICE '   🏛️  المحافظات: % (المتوقع 27)', gov_count;
  RAISE NOTICE '   🏘️  المدن: % (المتوقع 200+)', city_count;
END;
$$;
