...
INSERT INTO auction_bids (id, ad_id, bidder_id, amount, created_at) VALUES
  ('bid00001-0000-0000-0000-000000000001', '11111111-0001-0001-0001-000000000002', 'c3333333-3333-3333-3333-333333333333', 385000, NOW() - INTERVAL '12 hours'),
  ('bid00001-0000-0000-0000-000000000002', '11111111-0001-0001-0001-000000000002', 'e5555555-5555-5555-5555-555555555555', 395000, NOW() - INTERVAL '8 hours'),
  ('bid00001-0000-0000-0000-000000000003', '11111111-0001-0001-0001-000000000002', 'c3333333-3333-3333-3333-333333333333', 405000, NOW() - INTERVAL '4 hours')
ON CONFLICT (id) DO NOTHING;

-- Bids on سامسونج S24 Ultra (ad phone 002)
INSERT INTO auction_bids (id, ad_id, bidder_id, amount, created_at) VALUES
  ('bid00002-0000-0000-0000-000000000001', '22222222-0002-0002-0002-000000000002', 'd4444444-4444-4444-4444-444444444444', 39000, NOW() - INTERVAL '20 hours'),
  ('bid00002-0000-0000-0000-000000000002', '22222222-0002-0002-0002-000000000002', 'a1111111-1111-1111-1111-111111111111', 41000, NOW() - INTERVAL '10 hours'),
  ('bid00002-0000-0000-0000-000000000003', '22222222-0002-0002-0002-000000000002', 'd4444444-4444-4444-4444-444444444444', 43000, NOW() - INTERVAL '3 hours')
ON CONFLICT (id) DO NOTHING;

-- Bids on شنطة Michael Kors (ad fashion 002)
INSERT INTO auction_bids (id, ad_id, bidder_id, amount, created_at) VALUES
  ('bid00003-0000-0000-0000-000000000001', '44444444-0004-0004-0004-000000000002', 'b2222222-2222-2222-2222-222222222222', 2200, NOW() - INTERVAL '6 hours'),
  ('bid00003-0000-0000-0000-000000000002', '44444444-0004-0004-0004-000000000002', 'e5555555-5555-5555-5555-555555555555', 2500, NOW() - INTERVAL '2 hours')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO conversations (id, ad_id, buyer_id, seller_id, last_message_at) VALUES
  ...
  ('conv0001-0000-0000-0000-000000000001', '11111111-0001-0001-0001-000000000001', 'c3333333-3333-3333-3333-333333333333', 'a1111111-1111-1111-1111-111111111111', NOW() - INTERVAL '1 hour'),
  -- نورا بتسأل فاطمة عن الآيفون
  ('conv0001-0000-0000-0000-000000000002', '22222222-0002-0002-0002-000000000001', 'd4444444-4444-4444-4444-444444444444', 'b2222222-2222-2222-2222-222222222222', NOW() - INTERVAL '30 minutes')
ON CONFLICT (id) DO NOTHING;

-- Messages in conversation 1
INSERT INTO messages (id, conversation_id, sender_id, content, is_read, created_at) VALUES
  ('msg00001-0000-0000-0000-000000000001', 'conv0001-0000-0000-0000-000000000001', 'c3333333-3333-3333-3333-333333333333', 'السلام عليكم، السيارة لسه متاحة؟', true, NOW() - INTERVAL '2 hours'),
  ('msg00001-0000-0000-0000-000000000002', 'conv0001-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'وعليكم السلام، أيوا متاحة الحمد لله', true, NOW() - INTERVAL '1 hour 50 minutes'),
  ('msg00001-0000-0000-0000-000000000003', 'conv0001-0000-0000-0000-000000000001', 'c3333333-3333-3333-3333-333333333333', 'تمام، ممكن أجي أعاينها بكرة؟', true, NOW() - INTERVAL '1 hour 45 minutes'),
  ('msg00001-0000-0000-0000-000000000004', 'conv0001-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'أكيد، أي وقت يناسبك. أنا في مدينة نصر', false, NOW() - INTERVAL '1 hour')
ON CONFLICT (id) DO NOTHING;

-- Messages in conversation 2
INSERT INTO messages (id, conversation_id, sender_id, content, is_read, created_at) VALUES
  ('msg00002-0000-0000-0000-000000000001', 'conv0001-0000-0000-0000-000000000002', 'd4444444-4444-4444-4444-444444444444', 'أهلاً، الآيفون ده أصلي ولا كوبي؟', true, NOW() - INTERVAL '45 minutes'),
  ('msg00002-0000-0000-0000-000000000002', 'conv0001-0000-0000-0000-000000000002', 'b2222222-2222-2222-2222-222222222222', 'أصلي 100% يا قمر، معاه العلبة والفاتورة', true, NOW() - INTERVAL '40 minutes'),
  ('msg00002-0000-0000-0000-000000000003', 'conv0001-0000-0000-0000-000000000002', 'd4444444-4444-4444-4444-444444444444', 'لو 50 ألف ممكن آخده؟', false, NOW() - INTERVAL '30 minutes')
ON CONFLICT (id) DO NOTHING;
