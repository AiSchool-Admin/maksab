...
INSERT INTO stores (id, user_id, name, slug, description, main_category, theme, layout, primary_color, location_gov, location_area, phone, is_verified, status) VALUES
  -- 🚗 متجر محمد أحمد للسيارات
  ('f1111111-1111-1111-1111-111111111111',
   'a1111111-1111-1111-1111-111111111111',
   'سيارات محمد أحمد',
   'mohamed-cars',
   'أكبر معرض سيارات مستعملة في مدينة نصر — خبرة 10 سنين — كل السيارات مضمونة',
   'cars', 'modern', 'grid', '#1B7A3D',
   'القاهرة', 'مدينة نصر', '01012345678', true, 'active'),
  -- 📱 متجر فاطمة للموبايلات
  ('f2222222-2222-2222-2222-222222222222',
   'b2222222-2222-2222-2222-222222222222',
   'موبايلات فاطمة',
   'fatma-phones',
   'موبايلات أصلية ومضمونة — آيفون وسامسونج — جديد ومستعمل',
   'phones', 'classic', 'grid', '#D4A843',
   'الجيزة', 'المهندسين', '01198765432', false, 'active'),
