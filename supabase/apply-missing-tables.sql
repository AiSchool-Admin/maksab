...
-- for buy_requests and analytics_events
...
-- ════════════════════════════════════════════
-- 4. RLS Policies for Buy Requests
-- ════════════════════════════════════════════
...
BEGIN
  ...
  RAISE NOTICE '✅ buy_requests table created';
  RAISE NOTICE '✅ buy_request_matches table created';
  RAISE NOTICE '✅ find_matches_for_buy_request() function created';
